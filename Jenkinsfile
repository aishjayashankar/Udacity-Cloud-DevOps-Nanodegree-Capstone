node {
    def registry1 = 'aishwaryajayashankar/testblueimage'
    def registry2 = 'aishwaryajayashankar/testgreenimage'
    ...
    stage('Deploying to AWS EKS') {
      ...
      dir ('./') {
        withAWS(credentials: 'ecr_credentials', region: 'us-east-2') {
            sh "aws eks --region us-east-2 update-kubeconfig --name newest-cluster"
